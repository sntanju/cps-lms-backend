...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "A blog post. Drafts are kept out of every reader's response by the controller, not by the client's query.";
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A course in the catalogue. Lessons, enrollments and quizzes all hang off this.';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Joins one student to one course. Progress and quiz results hang off this in later phases.';
  ...
  attributes: {
    ...
    student: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    studentCourseKey: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A unit of a course. Ordered, and owned by whoever owns the course.';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One MCQ question. correctIndex must never be serialised to a student \u2014 see the take endpoint in the quiz controller.';
...
export interface ApiQuizResultQuizResult extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One graded attempt at a quiz. Written only by the grading service, never by a client.';
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An MCQ quiz attached to a course. Its questions hold the correct answers, which students must never receive.';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
...
export interface ApiRefreshTokenRefreshToken
  ...
  attributes: {
    ...
    tokenHash: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
